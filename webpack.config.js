  ...
  plugins: [
    new CopyPlugin({
      patterns: [
        ...
        { from: resolve(__dirname, 'impose.bat'), to: resolve(__dirname, 'build') },
        { from: resolve(__dirname, 'sort.bat'), to: resolve(__dirname, 'build') },
        { from: resolve(__dirname, 'validate.bat'), to: resolve(__dirname, 'build') },
      ],
    }),
  ],
};
