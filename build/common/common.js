...
var createFolder = function (folderName) { return __awaiter(void 0, void 0, void 0, function () {
    var error_1, mkdirErr_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 7]);
                return [4 /*yield*/, (0, promises_1.access)(folderName, promises_1.constants.F_OK)];
            case 1:
                _a.sent();
            ...
            case 3:
                _a.trys.push([3, 5, , 6]);
                return [4 /*yield*/, (0, promises_1.mkdir)(folderName)];
            case 4:
                _a.sent();
            ...
            case 5:
                mkdirErr_1 = _a.sent();
                console.log('Error creating output folder:', mkdirErr_1);
                return [3 /*break*/, 6];
