...
var getOffsets = function (updatedWidth, updatedHeight, sizeType, layoutWidth, layoutHeight, order, pagesAmount, step) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        ...
        switch (sizeType) {
            case types_js_1.SIZE_TYPE.HALF: {
                leftOffset = 0;
                topOffset = 0;
                break;
            }
            case types_js_1.SIZE_TYPE.THREE_QUARTERS: {
                leftOffset = 0;
                topOffset = topOffset + constants_js_1.CUT_OFF + yPadding;
                break;
            }
            case types_js_1.SIZE_TYPE.HALF_CUTTED: {
            ...
            case types_js_1.SIZE_TYPE.THREE_HORISONTAL_HALF: {
                leftSpace = layoutWidth.minusMargins().getHalf() - updatedWidth;
                leftOffset = layoutWidth.minusMargin() - updatedWidth - (leftSpace / 2);
            ...
            case types_js_1.SIZE_TYPE.FOUR_HORISONTAL_FULL: {
                if (order === 0) {
                    if (innerPadding) {
            ...
            case types_js_1.SIZE_TYPE.TWO_VERTICAL_ONE_HORISONTAL_HALF: {
                if (order === 1) {
            ...
            case types_js_1.SIZE_TYPE.TWO_HORISONTAL_HALF: {
                leftOffset = layoutWidth.getHalf() + xPadding;
                if (order === 1) {
                    topOffset = Math.round(topOffset.plusMargin() + yPadding);
                }
            ...
            case types_js_1.SIZE_TYPE.FOUR_VERTICAL_HALF: {
                if (order === 1) {
                    leftOffset = layoutWidth.getHalf() + xPadding;
                    topOffset = Math.round(topOffset.plusMargin() + yPadding);
                }
            ...
            case types_js_1.SIZE_TYPE.TWO_VERTICAL_CUSTOM: {
            ...
            case types_js_1.SIZE_TYPE.COVER: {
