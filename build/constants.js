...
exports.ALBUM_DATA = (_a = {},
    ...
    _a);
exports.LAYOUT_TYPE_SIZES_MAPPING = (_c = {},
    _c[types_1.LAYOUT_TYPE.FULL] = [types_1.SIZE_TYPES.FULL],
    _c[types_1.LAYOUT_TYPE.COVER] = [types_1.SIZE_TYPES.COVER],
    _c[types_1.LAYOUT_TYPE.F1C1] = [types_1.SIZE_TYPES.HALF, types_1.SIZE_TYPES.HALF_CUTTED],
    _c[types_1.LAYOUT_TYPE.F1H3] = [types_1.SIZE_TYPES.HALF, types_1.SIZE_TYPES.THREE_HORISONTAL_HALF, types_1.SIZE_TYPES.THREE_HORISONTAL_HALF, types_1.SIZE_TYPES.THREE_HORISONTAL_HALF],
    _c[types_1.LAYOUT_TYPE.H4] = [types_1.SIZE_TYPES.FOUR_HORISONTAL_FULL, types_1.SIZE_TYPES.FOUR_HORISONTAL_FULL, types_1.SIZE_TYPES.FOUR_HORISONTAL_FULL, types_1.SIZE_TYPES.FOUR_HORISONTAL_FULL],
    _c[types_1.LAYOUT_TYPE.F1V2H1] = [types_1.SIZE_TYPES.HALF, types_1.SIZE_TYPES.TWO_VERTICAL_ONE_HORISONTAL_HALF, types_1.SIZE_TYPES.TWO_VERTICAL_ONE_HORISONTAL_HALF, types_1.SIZE_TYPES.TWO_VERTICAL_ONE_HORISONTAL_HALF],
    _c[types_1.LAYOUT_TYPE.F1H2] = [types_1.SIZE_TYPES.HALF, types_1.SIZE_TYPES.TWO_HORISONTAL_HALF, types_1.SIZE_TYPES.TWO_HORISONTAL_HALF],
    _c[types_1.LAYOUT_TYPE.F1V4] = [types_1.SIZE_TYPES.HALF, types_1.SIZE_TYPES.FOUR_VERTICAL_HALF, types_1.SIZE_TYPES.FOUR_VERTICAL_HALF, types_1.SIZE_TYPES.FOUR_VERTICAL_HALF, types_1.SIZE_TYPES.FOUR_VERTICAL_HALF,],
    _c[types_1.LAYOUT_TYPE.XXLF1V2] = [types_1.SIZE_TYPES.THREE_QUARTERS, types_1.SIZE_TYPES.TWO_VERTICAL_CUSTOM, types_1.SIZE_TYPES.TWO_VERTICAL_CUSTOM],
    _c[types_1.LAYOUT_TYPE.F1V2] = [types_1.SIZE_TYPES.HALF, types_1.SIZE_TYPES.TWO_VERTICAL_RIGHT_CENTER, types_1.SIZE_TYPES.TWO_VERTICAL_RIGHT_CENTER],
    _c[types_1.LAYOUT_TYPE.VIGNETTE] = [types_1.SIZE_TYPES.FULL],
    _c);
exports.PADDINGS = (_d = {},
    ...
    _d[types_1.SIZE_TYPES.TWO_VERTICAL_RIGHT_CENTER] = {
        xPadding: 186,
        yPadding: 186,
        innerPadding: 50
    },
