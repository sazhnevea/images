...
export var getOffsets = function getOffsets(_ref) {
  var updatedWidth = _ref.updatedWidth,
    updatedHeight = _ref.updatedHeight,
    sizeType = _ref.sizeType,
    layoutWidth = _ref.layoutWidth,
    layoutHeight = _ref.layoutHeight,
    order = _ref.order,
    pagesAmount = _ref.pagesAmount,
    step = _ref.step;
  var leftOffset = 0;
  var topOffset = 0;
  var _PADDINGS$sizeType = PADDINGS[sizeType],
    xPadding = _PADDINGS$sizeType.xPadding,
    yPadding = _PADDINGS$sizeType.yPadding,
    innerPadding = _PADDINGS$sizeType.innerPadding;
  switch (sizeType) {
    ...
    case SIZE_TYPES.HALF_CUTTED:
      {
        var leftSpace = layoutWidth.minusMargins().getHalf() - updatedWidth;
    ...
    case SIZE_TYPES.THREE_HORISONTAL_HALF:
      {
        var _leftSpace = layoutWidth.minusMargins().getHalf() - updatedWidth;
        leftOffset = layoutWidth.minusMargin() - updatedWidth - _leftSpace / 2;
